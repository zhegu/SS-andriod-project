package org.shuashuaent.client.pay;
...
import org.shuashuaent.client.pay.unionpay.UnionPayment;
...
//				map.put(Param.PARTNER_ID, partnerId);
//				map.put(Param.KEY, key);
//				map.put(Param.APP_FEE_ID, appFeeId);
//				map.put(Param.MONEY, money);
//				map.put(Param.TRADE_ID, tradeId);
//				map.put(Param.APP_ID, appId);
//				map.put(Param.QN, qn);
//				map.put(Param.TRADE_NAME, tradeName);
