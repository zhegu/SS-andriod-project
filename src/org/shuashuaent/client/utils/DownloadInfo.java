...
public class DownloadInfo {
	...
	public DownloadInfo(String url, String dir) {
		...
		if (dir.equals("download")) {
			mFileDir = Pub.getTrendsSaveFilePathSD(dir);
		} else {
	...
	private String msGamePackage;// 游戏包名
	private int mnLuaCallback;// 下载游戏脚本回调方法

	public String getGamePackage() {
		return msGamePackage;
	}

	public void setGamePackage(String gamePackage) {
		msGamePackage = gamePackage;
	}

	public int getLuaCallback() {
		return mnLuaCallback;
	}

	public void setLuaCallback(int luaCallback) {
		mnLuaCallback = luaCallback;
	}
	...
	public String getFilePath() {
		if (msGamePackage != null && mnLuaCallback > 0) {
			return mFileDir + getGamePackage() + ".zip";
		} else {
	...
	public String getTempPath() {
		return mFileDir + getFileName(getFileNameFromUrl(downloadUrl)) + "_tmp" + "_" + getTotalSize();
	}
}