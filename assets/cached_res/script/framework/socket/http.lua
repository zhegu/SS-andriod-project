local socket = Load.LuaRequire("script.framework.socket.socket")
local url = Load.LuaRequire("script.framework.socket.url")
local ltn12 = Load.LuaRequire("script.framework.socket.ltn12")
local mime = Load.LuaRequire("script.framework.socket.mime")
local string = require("string")
local headers = Load.LuaRequire("script.framework.socket.headers")
local base = _G
