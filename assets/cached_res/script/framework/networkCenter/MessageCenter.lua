...
--	end
    messageTable[messageType] = {};
    table.insert(messageTable[messageType], logicFunction);
end
...
--移除所有的注册消息
function removeMessageCenterAllMessage()
	messageTable = {}
end
...
local isSocketPause = false;--消息是否暂停

--[[--
--获取当前Socket消息是否暂停
--]]
function getSocketIsPause()
	return isSocketPause;
end
