...
local function initView()
	...
	label_exchange_coin = cocostudio.getUILabelAtlas(view, "label_exchange_coin");
...
function setDialogData(text, yuanbaoNum)
	...
	if mYuanBaoNum ~= nil and mYuanBaoNum > 0 then
		label_exchange_coin:setStringValue("" .. (mYuanBaoNum * 100 * ServerConfig.getConversionCoefficient()));
	end
end
...
function callback_Button_close(component)
	...
	elseif component == RELEASE_UP then
		--抬起
		GamePub.closeDialogAmin(Panel_14, close)
