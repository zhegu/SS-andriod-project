...
function AndroidExitController:addCallback()
	...
	framework.bindEventCallback(cocostudio.getComponent(AndroidExitLogic.view,"btn_continue"), AndroidExitLogic.callback_btn_continue, BUTTON_CLICK, BUTTON_SOUND_CLICK + BUTTON_ANIMATION_ZOOM_OUT);
end
...
function AndroidExitController:removeCallback()
	...
	framework.unbindEventCallback(cocostudio.getComponent(AndroidExitLogic.view,"btn_continue"), AndroidExitLogic.callback_btn_continue, BUTTON_CLICK, BUTTON_SOUND_CLICK + BUTTON_ANIMATION_ZOOM_OUT);
end
